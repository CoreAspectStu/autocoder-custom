...
from custom.uat_gateway.utils.errors import OrchestratorError, handle_errors
from custom.uat_gateway.state_manager.state_manager import StateManager, ExecutionState
from custom.uat_gateway.journey_extractor.journey_extractor import JourneyExtractor, Journey
from custom.uat_gateway.test_generator.test_generator import TestGenerator, GeneratedTest
from custom.uat_gateway.test_executor.test_executor import TestExecutor, TestResult
from custom.uat_gateway.test_executor.performance_detector import PerformanceDetector  # Feature #186
from custom.uat_gateway.result_processor.result_processor import ResultProcessor, ProcessedResult
from custom.uat_gateway.kanban_integrator.kanban_integrator import KanbanIntegrator, JourneyCard, ScenarioCard, BugKanbanCard
from custom.uat_gateway.orchestrator.prerequisite_validator import PrerequisiteValidator, ValidationResult
from custom.uat_gateway.ui.events import get_event_manager  # Feature #231: Success notifications
...
class Orchestrator:
    ...
    def initialize_components(self):
        ...
        # Test Generator
        from custom.uat_gateway.test_generator.test_generator import TestConfig
        ...
        # Test Executor
        from custom.uat_gateway.test_executor.test_executor import ExecutionConfig
    ...
    def _update_kanban(
        ...
        try:
            ...
            from custom.uat_gateway.kanban_integrator.kanban_integrator import CardStatus
...
"""
    ...
    def generate_unified_report(
        ...
        """
        from custom.uat_gateway.adapters.visual.visual_adapter import ComparisonResult
        from custom.uat_gateway.adapters.a11y.a11y_adapter import ScanResult
        from custom.uat_gateway.adapters.api.api_adapter import APITestResult
