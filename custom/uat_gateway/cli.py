#!/usr/bin/env python3
"""
UAT Gateway CLI - Main entry point for the package

This script provides a command-line interface for running UAT cycles.
"""
...
try:
    from uat_gateway.orchestrator.orchestrator import Orchestrator, OrchestratorConfig, OrchestratorResult
    from uat_gateway.utils.logger import get_logger
except ImportError:
    # If running from source directory, add parent to path
...
Examples:
  ...
  uat-gateway --spec my_spec.yaml

  # Run with custom base URL
  uat-gateway --base-url http://localhost:4000

  # Run with verbose logging
  uat-gateway --verbose

  # Run without Kanban integration
  uat-gateway --no-kanban
