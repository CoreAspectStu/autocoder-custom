"""
Alembic Environment Configuration for UAT AutoCoder Plugin

This file is used by Alembic to configure the migration environment.
It provides the connection to the database and the context for running migrations.
"""
...
from database import Base, UATTestFeature, UATTestPlan
...
# UAT database is at ~/.autocoder/uat_tests.db
